...
export function Sidebar() {
  ...
  return (
    <aside
      className="hidden md:flex sidebar-lines fixed top-4 left-4 bottom-4 w-(--sidebar-w-md) xl:w-(--sidebar-w) flex-col p-[26px_20px] z-100 overflow-hidden border border-khaki/15 rounded-2xl bg-ink shadow-[0_8px_48px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(138,126,106,0.08)]"
      aria-label="Primary"
    >
